...
import { getTvDetails, searchTv, TmdbSearchResult } from '../../lib/tmdb'
import { createSeries, getArchivedTmdbTvIds } from './api'
...
export function TvSearch({ query, onArchived }: Props): React.JSX.Element {
  ...
  async function handleArchive(result: TmdbSearchResult): Promise<void> {
    setError(null)
