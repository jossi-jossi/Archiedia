...
import { createWebtoon, getArchivedNaverWebtoonIds } from './api'
...
export function NaverSearch({ query, onArchived }: Props): React.JSX.Element {
  ...
  async function handleArchive(result: WebtoonSearchResult): Promise<void> {
    setError(null)
              ...
              <div
                style={{
                  ...
                  background: r.thumbnailUrl
                    ? `center / cover no-repeat url(${r.thumbnailUrl})`
